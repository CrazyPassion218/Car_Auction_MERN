  ...
  return (
    <div>
        ...
        <Grid xs={12} md={12} lg={12} sx={{display: 'flex', justifyContent: 'center', marginLeft: '-10px', marginTop: '-250px'}}>
            <MKBox height={imageHeight} width={imageWidth / 4} sx={{backgroundColor: 'rgba(0,0,0,0)'}} onMouseEnter={ () => mouseEnterEvent(1)} zIndex={5}/>
            <MKBox height={imageHeight} width={imageWidth / 4} sx={{backgroundColor: 'rgba(0,0,0,0)'}} onMouseEnter={ () => mouseEnterEvent(2)} zIndex={5}/>
            <MKBox height={imageHeight} width={imageWidth / 4} sx={{backgroundColor: 'rgba(0,0,0,0)'}} onMouseEnter={ () => mouseEnterEvent(3)} zIndex={5}/>
            <MKBox height={imageHeight} width={imageWidth / 4} sx={{backgroundColor: 'rgba(0,0,0,0)'}} onMouseEnter={ () => mouseEnterEvent(4)} zIndex={5}/>
        </Grid>
    </div>
  );
}
